...
public class InvoiceServiceTest {
    ...
    void testCreateInvoice_Success() {
        ...
        CreateInvoiceDTO createDto = new CreateInvoiceDTO(companyId, clientId, "INV-001", LocalDateTime.now().plusDays(14), 0.25f, List.of());
    ...
    void testUpdateInvoice_Success() {
        ...
        UpdateInvoiceDTO updateDto = new UpdateInvoiceDTO(invoiceId, LocalDateTime.now().plusDays(30), 0.25f, List.of(new InvoiceItemDTO(null, "name", 2, new BigDecimal("500.00"))), InvoiceStatus.SENT);
    ...
    void testCreateInvoice_CompanyNotFound() {
        UUID companyId = UUID.randomUUID();
        CreateInvoiceDTO dto = new CreateInvoiceDTO(companyId, UUID.randomUUID(), "INV-X", LocalDateTime.now(), 0.25f, List.of());
    ...
    void testCreateInvoice_ClientNotFound() {
        UUID companyId = UUID.randomUUID();
        UUID clientId = UUID.randomUUID();
        CreateInvoiceDTO dto = new CreateInvoiceDTO(companyId, clientId, "INV-X", LocalDateTime.now(), 0.25f, List.of());
    ...
    void testUpdateInvoice_InvoiceNotFound() {
        UUID id = UUID.randomUUID();
        UpdateInvoiceDTO dto = new UpdateInvoiceDTO(id, LocalDateTime.now(), 0.25f, List.of(), InvoiceStatus.SENT);
    ...
    void testCreateInvoice_NumberAlreadyExists() {
        CreateInvoiceDTO createDto = new CreateInvoiceDTO(UUID.randomUUID(), UUID.randomUUID(), "INV-EXIST", LocalDateTime.now(), 0.25f, List.of());
